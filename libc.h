// don't forget to add following line:
...
static inline i64 syscall6(Syscall sc, i64 a1, i64 a2, i64 a3, i64 a4, i64 a5, i64 a6) {
    i64          ret;
    ...
    asm volatile("syscall"
                 : "=a"(ret)
                 : "a"(sc), "D"(a1), "S"(a2), "d"(a3), "r"(r10), "r"(r8), "r"(r9)
                 : "rcx", "r11", "memory");
    return ret;
}
static inline i64 syscall3(Syscall nr, i64 a, i64 b, i64 c) {
    i64 ret;
